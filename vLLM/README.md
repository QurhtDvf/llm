...
- **現在** — GitHub スター数は 5 万以上。オープンソース LLM サービングのデファクトスタンダードとして確立されている。
...
| | vLLM | TensorRT-LLM | TGI (HuggingFace) | Ollama | SGLang |
|---|---|---|---|---|---|
| **開発元** | UC Berkeley | NVIDIA | Hugging Face | Ollama Inc. | UC Berkeley |
| **セットアップ難易度** | 低〜中 | 高 | 低〜中 | 非常に低 | 低〜中 |
| **スループット** | ◎ 高い | ◎ 最高（NVIDIA 限定） | ○ 中〜高 | △ 低い | ◎ 高い |
| **メモリ効率** | ◎ PagedAttention | ○ | ○ | △ | ◎ RadixAttention |
| **OpenAI 互換 API** | ✅ | 要設定 | ✅ | ✅ | ✅ |
| **対応ハードウェア** | マルチ | NVIDIA 専用 | マルチ | マルチ | マルチ |
| **本番環境向け** | ✅ | ✅ | ✅ | △ | ✅ |
| **同時リクエスト処理** | ✅ | ✅ | ✅ | ❌ | ✅ |
